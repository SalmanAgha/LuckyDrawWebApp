...
if($connect)
{
    ...
    $query = mysqli_query($connect,"SELECT ticketid,contestid,userid,status,dateofcreation FROM `ticket`");
    if (!$query
  )  {
    ...
    else
    {
      ...
      data-dateofcreation='".$row["dateofcreation"]."'
        ...
        (
          "Empty"     => $Action,
          "contestid" => $row["contestid"],"userid" => $row["userid"],"status" => $row["status"],"dateofcreation" => $row["dateofcreation"]
