...
function tbluser(){
   ...
   $("#datatable").DataTable({
        ...
        "columns": [
         { "data": "Empty"},
           { "data": "name"} ,{ "data": "username"} ,{ "data": "email"} ,{ "data": "password"} ,{ "data": "doc"} ,{ "data": "status"} ,{ "data": "pancard"} ,{ "data": "aadharcard"} 
...
$(document).on("click", ".edit-modal", function(){
         ...
         $("#id2").val($(this).attr("id"));$("#name1").val($(this).data("name"));$("#username1").val($(this).data("username"));$("#email1").val($(this).data("email"));$("#password1").val($(this).data("password"));$("#doc1").val($(this).data("doc"));$("#status1").val($(this).data("status"));$("#pancard1").val($(this).data("pancard"));$("#aadharcard1").val($(this).data("aadharcard"));
  ...
  if (result.value) {  
    $.ajax( {
            ...
            data: {
                ...
                name:name,username:username,email:email,password:password,doc:doc,status:status,pancard:pancard,aadharcard:aadharcard
 ...
 var aadharcard1 = $("#aadharcard1").val(); 
  ...
  if (result.value) {  
        $.ajax( {
            ...
            method: "POST",
            data: {id:id,
                 name1:name1,username1:username1,email1:email1,password1:password1,doc1:doc1,status1:status1,pancard1:pancard1,aadharcard1:aadharcard1
            },
            dataType: "JSON",
            success: function (data) 
            {
