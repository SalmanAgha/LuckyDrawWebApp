...
<body>
   ...
   <?php include "navbar.php"; ?>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive nowrap" style=" overflow-x: auto;border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        <thead>
                                    <tr>
                                    <th></th><th>Date </th><th>Amount</th><th>Type</th><th>User ID</th><th>Description</th><th>Status</th>
                                    </tr>
                                        </thead>
                                        <tbody>
                                        </tbody>
    ...
    <div class="col-sm-10">
    <input class="form-control  " type="text" placeholder="Enter Date" id="date"><span class="help-block custom-block-hide" id="1v"><small ></small></span>
    </div>
    ...
    <div class="col-sm-10">
    <input class="form-control  " type="text" placeholder="Enter Type" id="type"><span class="help-block custom-block-hide" id="3v"><small ></small></span>
    </div>
    </div><div class="form-group row">
    <label for="example-text-input" class="col-sm-2 col-form-label text-right">User ID</label>
    <div class="col-sm-10">
    <input class="form-control numbersOnly" type="number" placeholder="Enter User Id" id="userid"><span class="help-block custom-block-hide" id="4v"><small ></small></span>
    </div>
    </div><div class="form-group row">
    ...
    <label for="example-text-input" class="col-sm-2 col-form-label text-right">Date </label>
    <div class="col-sm-10">
    <input class="form-control  " type="text" placeholder="Enter Date" id="date1"><span class="help-block custom-block-hide" id="1v1"><small ></small></span>
    </div>
    </div><div class="form-group row">
    <label for="example-text-input" class="col-sm-2 col-form-label text-right">Amount</label>
    <div class="col-sm-10">
    ...
    <label for="example-text-input" class="col-sm-2 col-form-label text-right">Type</label>
    <div class="col-sm-10">
    <input class="form-control  " type="text" placeholder="Enter Type" id="type1"><span class="help-block custom-block-hide" id="3v1"><small ></small></span>
    </div>
    </div><div class="form-group row">
    <label for="example-text-input" class="col-sm-2 col-form-label text-right">User ID</label>
    <div class="col-sm-10">
