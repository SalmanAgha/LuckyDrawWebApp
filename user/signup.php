                            ...
                            <form id="registerform" class="needs-validation" novalidate>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control" id="pancard" name="pancard" placeholder="Enter Pan Card" required>
                                                <div class="invalid-tooltip">
                                                      Please fill this correctly!
                                                </div>
                                                <div class="password-match-tooltip"></div> <!-- add this line -->
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control" id="aadharcard" name="aadharcard" placeholder="Enter Aadhar Card" required>
                                                <div class="invalid-tooltip">
                                                      Please fill this correctly!
                                                </div>
                                                <div class="password-match-tooltip"></div> <!-- add this line -->
